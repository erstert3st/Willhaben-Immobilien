...
class Db_handler:
    ...
    def insert_listings(self, table_name, listings):
        ...
        sql = f"INSERT OR REPLACE INTO {table_name} ({self.columns}) VALUES ({placeholders})"
